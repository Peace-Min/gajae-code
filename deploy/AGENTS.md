...
`deploy/LOCAL_DEPLOYMENT.md`, which is intentionally ignored by Git.
...
8. Update `deploy/HANDOFF.md` with findings, changes, tests, and remaining work.
